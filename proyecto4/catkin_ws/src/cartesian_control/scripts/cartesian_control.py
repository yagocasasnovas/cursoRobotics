...
def cartesian_control(joint_transforms, b_T_ee_current, b_T_ee_desired,red_control, q_current, q0_desired):
	...
	deltaX = tf.transformations.concatenate_matrices(b_T_ee_desired,b_T_ee_current_inverse)
	...
	jTee = tf.transformations.concatenate_matrices(b_T_ee_current,inv_join)
	jTrot_ee = [[jTee[0][0],jTee[0][1],jTee[0][2]],[jTee[1][0],jTee[1][1],jTee[1][2]],[jTee[2][0],jTee[2][1],jTee[2][2]]]
	print jTee
	print jTrot_ee
