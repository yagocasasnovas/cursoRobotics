...
class MoveArm(object):
	...
	def motion_plan(self, q_start, q_goal, q_min, q_max):
		...
		while loop:
			...
			node_temp.id = count
			node_temp.position = random_point
			
			closest_node_temp = closest_node(node_list,node_temp)
	...
	class node:
		...
		id = -1
		position = numpy.zeros(7)
		previous_node_id = -1
	
	def closest_node(listn,new_node):
		closest_node_return = -1
		closest_distance = 1000000
		for n in listn:
			dist = calculate_distance(n,new_node)
	...
	def calculate_distance(node1,node2):
		a = node1.position[0]*node2.position[0] + node1.position[1]*node2.position[1] + node1.position[2]*node2.position[2] + node1.position[3]*node2.position[3] + node1.position[4]*node2.position[4] + node1.position[5]*node2.position[5] + + node1.position[6]*node2.position[6]
		return numpy.sqrt(a)
